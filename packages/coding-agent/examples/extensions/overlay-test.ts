 ...
 *
 * Usage: ai --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@simpletoolsindiaorg/ai-tui";

export default function (ai: ExtensionAPI) {
	ai.registerCommand("overlay-test", {
