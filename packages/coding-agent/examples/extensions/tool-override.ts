 ...
 * - Routing tool calls to remote systems (e.g., ai-ssh-remote)
 ...
 *
 * Usage:
 *   ai -e ./tool-override.ts
 */

import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "@simpletoolsindiaorg/ai-coding-agent";
import type { TextContent } from "@simpletoolsindiaorg/ai-provider";
