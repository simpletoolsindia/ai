 ...
 * Delegates to ai-provider's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   ai -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (ai: ExtensionAPI) {
	ai.registerProvider("gitlab-duo", {
