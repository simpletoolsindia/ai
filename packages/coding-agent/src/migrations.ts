...
const MIGRATION_GUIDE_URL =
	"https://github.com/simpletoolsindiaorg/ai/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL =
	"https://github.com/simpletoolsindiaorg/ai/blob/main/packages/coding-agent/docs/extensions.md";
 ...
 * ~/.ai/agent/sessions/<encoded-cwd>/. This migration moves them
 * to the correct location based on the cwd in their session header.
 *
 * See: https://github.com/simpletoolsindiaorg/ai/issues/320
 */
 ...
 * Note: tools/ may contain fd/rg binaries extracted by ai, so only warn if it has other files.
 */
