...
export const MODELS = {
	...
	"ollama-cloud": {
		"deepseek-v3.1:671b": {
			...
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsReasoningEffort":false,"supportsLongCacheRetention":false},
			reasoning: true,
			input: ["text"],
			cost: {
				input: 0,
		...
		"deepseek-v4-flash": {
			...
			provider: "ollama-cloud",
			baseUrl: "https://ollama.com/v1",
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsReasoningEffort":false,"supportsLongCacheRetention":false,"requiresReasoningContentOnAssistantMessages":true,"thinkingFormat":"deepseek"},
			reasoning: true,
			thinkingLevelMap: {"minimal":null,"low":null,"medium":null,"high":"high","xhigh":"max"},
			input: ["text"],
			cost: {
