...
import { type AutocompleteProvider, CombinedAutocompleteProvider } from "@simpletoolsindiaorg/ai-tui";
...
describe("InteractiveMode.showLoadedResources", () => {
	...
	function createExtensionFixtures(): ExtensionFixture[] {
		return [
			...
			{
				path: "/tmp/project/.pi/npm/node_modules/ai-markdown-preview/extensions/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.pi/npm/node_modules/ai-markdown-preview/extensions/index.ts", {
					source: "npm:pi-markdown-preview",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.pi/npm/node_modules/ai-markdown-preview",
				}),
			},
			{
				path: "/tmp/project/.pi/npm/node_modules/@scope/ai-scoped/extensions/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.pi/npm/node_modules/@scope/ai-scoped/extensions/index.ts", {
					source: "npm:@scope/ai-scoped",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.pi/npm/node_modules/@scope/ai-scoped",
				}),
			},
			{
				path: "/tmp/project/.pi/git/github.com/HazAT/ai-interactive-subagents/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.pi/git/github.com/HazAT/ai-interactive-subagents/extensions/index.ts",
					{
						source: "git:github.com/HazAT/ai-interactive-subagents",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.pi/git/github.com/HazAT/ai-interactive-subagents",
					},
				),
			},
			{
				path: "/tmp/project/.pi/git/github.com/HazAT/ai-interactive-subagents/extensions/subagents/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.pi/git/github.com/HazAT/ai-interactive-subagents/extensions/subagents/index.ts",
					{
						source: "git:github.com/HazAT/ai-interactive-subagents",
						scope: "project",
						origin: "package",
...
"[Extensions]
  @scope/ai-scoped, answer.ts, cli-extension.ts, HazAT/ai-interactive-subagents, HazAT/ai-interactive-subagents:subagents, local-index, pi-markdown-preview, user-index"`);
	});
...
"[Extensions]
  project
    ...
    git:github.com/HazAT/ai-interactive-subagents
      extensions
  ...
  path
	...
	test("shows context paths relative to cwd while preserving full external paths", () => {
		const home = homedir();
		const cwd = path.join(home, "Development", "ai-mono");
		const fakeThis = createShowLoadedResourcesThis({
			quietStartup: false,
			cwd,
			contextFiles: [{ path: path.join(home, ".ai", "agent", "AGENTS.md") }, { path: path.join(cwd, "AGENTS.md") }],
		});
		...
		expect(output).toContain("~/.ai/agent/AGENTS.md, AGENTS.md");
	...
	test("shows full context paths when expanded", () => {
		...
		expect(output).toContain("~/Development/ai-mono/AGENTS.md");
