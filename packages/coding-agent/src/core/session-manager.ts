import { type AgentMessage, uuidv7 } from "@simpletoolsindiaorg/ai-agent";
...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, undefined/false if ai-generated (backward compatible) */
	fromHook?: boolean;
}
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, false if ai-generated */
	fromHook?: boolean;
}
 ...
 * Encodes cwd into a safe directory name under ~/.ai/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.ai/agent/sessions/<encoded-cwd>/).
	 */
