import type { Transport } from "@simpletoolsindiaorg/ai-provider";
...
export class SettingsManager {
	...
	getClearOnShrink(): boolean {
		...
		return process.env.AI_CLEAR_ON_SHRINK === "1";
	}
	...
	getShowHardwareCursor(): boolean {
		return this.settings.showHardwareCursor ?? process.env.AI_HARDWARE_CURSOR === "1";
	}
