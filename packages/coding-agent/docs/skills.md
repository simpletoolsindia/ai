> ai can create skills. Ask it to build one for your use case.
...
Discovery rules:
- In `~/.ai/agent/skills/` and `.ai/skills/`, direct root `.md` files are discovered as individual skills
...
For project-level Claude Code skills, add to `.ai/settings.json`:
