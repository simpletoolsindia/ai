...
const packages = [
	{ directory: "packages/ai", name: "@simpletoolsindiaorg/ai-provider" },
	{ directory: "packages/tui", name: "@simpletoolsindiaorg/ai-tui" },
	{ directory: "packages/agent", name: "@simpletoolsindiaorg/ai-agent" },
	{ directory: "packages/coding-agent", name: "@simpletoolsindiaorg/ai-coding-agent" },
];
...
if (rootPackageJson.name !== "ai-monorepo") {
