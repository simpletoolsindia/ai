...
- Fixed prompt history navigation to place the cursor at the start when browsing upward and at the end when browsing downward, so repeated Up/Down traverses multiline prompts immediately ([#5454](https://github.com/simpletoolsindiaorg/ai/issues/5454)).
- Fixed intermittent Shift+Enter handling by making Kitty keyboard protocol fallback response-driven instead of timeout-driven ([#5188](https://github.com/simpletoolsindiaorg/ai/issues/5188)).
- Fixed TUI rendering to clear stale lines when content shrinks to zero.
- Fixed autocomplete suggestions to re-query after editor cursor movement ([#5499](https://github.com/simpletoolsindiaorg/ai/pull/5499) by [@Roman-Galeev](https://github.com/Roman-Galeev)).

## [0.78.1] - 2026-06-04

### Fixed

- Fixed overlay focus restoration so non-capturing overlays remain interactive after UI rerenders and explicit focus release ([#5235](https://github.com/simpletoolsindiaorg/ai/pull/5235) by [@nicobailon](https://github.com/nicobailon)).
- Fixed tab width accounting in column slicing and overlay compositing so tab-containing output cannot exceed the terminal width ([#5218](https://github.com/simpletoolsindiaorg/ai/issues/5218)).
...
- Clarified the IME hardware cursor docs to state that cursor visibility remains opt-in ([#5200](https://github.com/simpletoolsindiaorg/ai-mono/issues/5200)).
...
- Added an opt-in Markdown renderer option to preserve source ordered-list markers for transcript rendering ([#5013](https://github.com/simpletoolsindiaorg/ai/issues/5013)).
...
- Replaced the optional `koffi` dependency for Windows VT input with a tiny vendored native helper, reducing install size while preserving Shift+Tab handling ([#4480](https://github.com/simpletoolsindiaorg/ai/issues/4480)).
...
- Added markdown list-item wrapping that preserves indentation for wrapped continuation lines ([#4327](https://github.com/simpletoolsindiaorg/ai-mono/pull/4327) by [@Perlence](https://github.com/Perlence)).

### Fixed

- Fixed markdown task-list checkbox rendering ([#4379](https://github.com/simpletoolsindiaorg/ai-mono/pull/4379) by [@Perlence](https://github.com/Perlence)).
- Fixed markdown rendering robustness for very large markdown files ([#4463](https://github.com/simpletoolsindiaorg/ai-mono/pull/4463) by [@ndanielherrera](https://github.com/ndanielherrera)).
- Fixed Kitty image placement when the viewport is shorter than the rendered image ([#4461](https://github.com/simpletoolsindiaorg/ai-mono/pull/4461) by [@xu0o0](https://github.com/xu0o0)).
- Fixed WezTerm Kitty keyboard protocol edge cases so escape handling remains correct ([#4482](https://github.com/simpletoolsindiaorg/ai-mono/pull/4482) by [@Felixoid](https://github.com/Felixoid)).
