...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@simpletoolsindiaorg/ai-coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@simpletoolsindiaorg/ai-coding-agent";
	 *
...
export interface ExtensionContext {
	...
	/** Gracefully shutdown ai and exit. Available in all contexts. */
	shutdown(): void;
...
export interface ExtensionAPI {
	 ...
	 *
	 * @example
	 * ai.unregisterProvider("my-proxy");
	 */
...
/** Configuration for registering a provider via ai.registerProvider(). */
...
export interface ProviderModelConfig {
	...
	reasoning: boolean;
	/** Maps ai thinking levels to provider/model-specific values; null marks a level unsupported. */
