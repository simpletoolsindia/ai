import type { AgentTool, ThinkingLevel } from "@simpletoolsindiaorg/ai-agent";
import { fauxAssistantMessage, fauxToolCall, type Model } from "@simpletoolsindiaorg/ai-provider";
