 ...
 * (logo + keybinding hints) with a custom component showing the ai mascot.
 */

import type { ExtensionAPI, Theme } from "@simpletoolsindiaorg/ai-coding-agent";
import { VERSION } from "@simpletoolsindiaorg/ai-coding-agent";

// --- PI MASCOT ---
// Based on ai_mascot.ts - the ai agent character
...
export default function (ai: ExtensionAPI) {
	...
	ai.registerCommand("builtin-header", {
