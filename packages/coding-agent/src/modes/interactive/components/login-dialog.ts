import { getOAuthProviders, type OAuthDeviceCodeInfo } from "@simpletoolsindiaorg/ai-provider/oauth";
import { Container, type Focusable, getKeybindings, Input, Spacer, Text, type TUI } from "@simpletoolsindiaorg/ai-tui";
...
export class LoginDialogComponent extends Container implements Focusable {
	...
	showPrompt(message: string, placeholder?: string): Promise<string> {
		// Clear previous prompt content so each step shows fresh info
		this.contentContainer.clear();
		this.contentContainer.addChild(new Spacer(1));
