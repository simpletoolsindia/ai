...
import type { SkillIndex, SkillResult, SkillScope } from "../types.ts";
...
export class SkillsManagerModal implements Focusable {
	...
	constructor(
		...
		callbacks: SkillsManagerCallbacks,
		options?: {
			managedSkills?: SkillIndex[];
			loadedSkills?: LoadedSkillRow[];
		},
	...
	render(width: number): string[] {
		...
		const searchHint =
			this.focusArea === "search" ? this.theme.fg("accent", "search") : this.theme.fg("dim", "search");
