...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/simpletoolsindiaorg/ai/releases/latest`;
	}
	const command = getSelfUpdateCommandForMethod(method, packageName, updatePackageName, npmCommand);
	if (command) {
...
// =============================================================================
// App Config (from package.json aiConfig)
// =============================================================================
...
const aiConfigName: string | undefined = pkg.aiConfig?.name;
export const PACKAGE_NAME: string = pkg.name || "@simpletoolsindiaorg/ai-coding-agent";
export const APP_NAME: string = aiConfigName || "ai";
export const APP_TITLE: string = aiConfigName ? APP_NAME : "α";
export const CONFIG_DIR_NAME: string = pkg.aiConfig?.configDir || ".ai";
...
const DEFAULT_SHARE_VIEWER_URL = "https://api.simpletoolsindiaorg.invalid/session/";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.AI_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
...
/** Get the agent config directory (e.g., ~/.ai/agent/) */
