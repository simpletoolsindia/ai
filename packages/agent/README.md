# @simpletoolsindiaorg/ai-agent

Stateful agent with tool execution and event streaming. Built on `@simpletoolsindiaorg/ai-provider`.

## Installation

```bash
npm install @simpletoolsindiaorg/ai-agent
```

## Quick Start

```typescript
import { Agent } from "@simpletoolsindiaorg/ai-agent";
...
```typescript
declare module "@simpletoolsindiaorg/ai-agent" {
...
```typescript
import { Agent, streamProxy } from "@simpletoolsindiaorg/ai-agent";
...
```typescript
import { agentLoop, agentLoopContinue } from "@simpletoolsindiaorg/ai-agent";
