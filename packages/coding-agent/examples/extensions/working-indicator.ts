 ...
 * working indicator shown while ai is streaming a response.
 *
 * Usage:
 *   ai --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore ai's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@simpletoolsindiaorg/ai-coding-agent";
...
export default function (ai: ExtensionAPI) {
	...
	ai.registerCommand("working-indicator", {
