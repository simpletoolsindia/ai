...
import { Container, Image, Spacer, Text } from "@simpletoolsindiaorg/ai-tui";
...
export class EarendilAnnouncementComponent extends Container {
	constructor() {
		...
		this.addChild(new Text(theme.bold(theme.fg("accent", "ai is a fork of pi")), 1, 0));
		this.addChild(new Spacer(1));
		this.addChild(
			new Text(theme.fg("muted", "The original pi project has joined Earendil. Read the upstream blog post:"), 1, 0),
		);
