 ...
 *
 * Usage: ai --extension ./examples/extensions/overlay-qa-tests.ts
 *
 * Commands:
...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@simpletoolsindiaorg/ai-coding-agent";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@simpletoolsindiaorg/ai-tui";
import { Input, matchesKey, truncateToWidth, visibleWidth } from "@simpletoolsindiaorg/ai-tui";
...
export default function (ai: ExtensionAPI) {
	...
	ai.registerCommand("overlay-animation", {
	...
	ai.registerCommand("overlay-anchors", {
	...
	ai.registerCommand("overlay-margins", {
	...
	ai.registerCommand("overlay-stack", {
	...
	ai.registerCommand("overlay-overflow", {
	...
	ai.registerCommand("overlay-edge", {
	...
	ai.registerCommand("overlay-percent", {
	...
	// Test maxHeight
	ai.registerCommand("overlay-maxheight", {
	...
	ai.registerCommand("overlay-sidepanel", {
	...
	ai.registerCommand("overlay-toggle", {
	...
	ai.registerCommand("overlay-passive", {
	...
	ai.registerCommand("overlay-focus", {
	...
	ai.registerCommand("overlay-streaming", {
	...
	private startProcess(): void {
		...
		this.proc = spawn("bash", [
			...
			for i in $(seq 1 100); do
				...
				DIR="/Users/nicobailon/Documents/development/ai-mono/packages/coding-agent/src/modes/interactive"
				...
				if [ $((i % 5)) -eq 0 ]; then
					echo -e "  \\033[32m✓ Successfully processed \${i} files in /Users/nicobailon/Documents/development/ai-mono\\033[0m"
				fi
				if [ $((i % 7)) -eq 0 ]; then
