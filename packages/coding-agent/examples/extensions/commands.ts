 ...
 * Commands Extension
 *
 * Demonstrates the ai.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@simpletoolsindiaorg/ai-coding-agent";

export default function commandsExtension(ai: ExtensionAPI) {
	ai.registerCommand("commands", {
