...
Play DOOM as an overlay in ai. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
ai --extension ./examples/extensions/doom-overlay
```
...
- [pi-doom](https://github.com/badlogic/pi-doom) for the original ai integration
