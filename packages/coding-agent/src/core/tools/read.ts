...
import type { Api, ImageContent, Model, TextContent } from "@simpletoolsindiaorg/ai-provider";
...
function getAiDocsClassification(absolutePath: string): CompactReadClassification | undefined {
...
function getCompactReadClassification(
	...
	const docsClassification = getAiDocsClassification(absolutePath);
